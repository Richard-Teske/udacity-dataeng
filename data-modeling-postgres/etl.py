...
def process_song_file(cur, filepath):
    ...
    # insert song record
    song_data_list = df[["song_id", "title", "artist_id", "year", "duration"]].values.tolist()
    for song_data in song_data_list:
        cur.execute(song_table_insert, song_data)
    
    # insert artist record
    artist_data_list = df[["artist_id", "artist_name", "artist_location", "artist_latitude", "artist_longitude"]].values.tolist()
...
def process_log_file(cur, filepath):
    ...
    time_df["week of year"] = time_df["week of year"].astype(int)
